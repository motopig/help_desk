...
function txtSearch() {
    ...
    if (vals == '') {
        ...
        window.location.href = "{{ URL::to($com->path.'/site/work/searchwork/3/"+vals+"') }}";
    }
}
...
<ol class="breadcrumb">
    ...
    <li><a href="{{ URL::to($com->path.'/site/work/processed') }}">已处理工单</a></li>
            ...
            <table class="table table-hover table-striped  tablesorter">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-xs btn-success view-link" 
                        href="{{ URL::to($com->path.'/site/work/workprocessed/'.$wo->id) }}">
                        开启
                        </a>
                        <a class="btn btn-xs btn-danger" 
                        href="{{ URL::to($com->path.'/site/work/workclosed/'.$wo->id) }}">
                        关闭
                        </a>
                    </td>
                    </tr>

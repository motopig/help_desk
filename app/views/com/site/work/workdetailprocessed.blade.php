...
<ol class="breadcrumb">
    ...
    <li><a href="{{ URL::to($com->path.'/site/work/untreated/') }}">已处理工单</a></li>
...
<hr >
<a href="{{ URL::to($com->path.'/site/work/workprocessed/'.$workerOrder['0']->id) }}">
<button class="btn btn-success">工单开启</button>
</a>

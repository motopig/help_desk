...
<hr class="hr-middle" />
<button type="button" class="btn btn-primary view-migrate">邀请</button>
...
$(function() {
    $('.view-migrate').click(function() {
        ...
        window.location.href = "{{ URL::to($com->path.'/admin/order/orderinvite/create?mark="+mark+"&admin_id="+val+"&status="+status+"&order_id=') }}"+vals;
    });
});
</script>
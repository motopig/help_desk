...
function txtSearch() {
    ...
    if (vals == '') {
        ...
        window.location.href = "{{ URL::to($com->path.'/admin/work/searchwork/2/"+vals+"') }}";
    }
}
...
function txtGroupSearch() {
    ...
    if (vals == '') {
        ...
        window.location.href = "{{ URL::to($com->path.'/admin/work/searchgroupwork/2/"+vals+"') }}";
    }
}
...
<li class="active">
<a href="#untreated" data-toggle="tab">
搜索 (处理中工单)
@if ($searchCount > 0)
            ...
            <table class="table table-hover table-striped  tablesorter">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        href="{{ URL::to($com->path.'/admin/work/allot/'.$wo->id) }}">
                        分配
                        </a>
                        ...
                        href="{{ URL::to($com->path.'/admin/work/dispatch/'.$wo->id) }}">
                        邀请
                        </a>
                        <!-- binway需求：完成按钮客服没权限操作，关闭按钮客服没权限操作 -->
                        @if ($level != '4')

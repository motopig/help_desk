    ...
    <div class="col-lg-12">
        <div class="table-responsive clearfix">
            ...
            <table class="table table-hover table-striped tablesorter scrollable">
                    ...
                    <tr>
                    <td>
                        <a href="{{ URL::to($com->path.'/admin/work/workdetail/'.$m->work_order_id.'?message_id='.$m->id) }}">
                            #{{$m->work_order_id}}</a>
                    </td>
                    <td>
                        @if ($m->work_status == '4')
                    ...
                    <td>
                        ...
                        href="{{ URL::to($com->path.'/admin/work/workdetail/'.$m->work_order_id.'?message_id='.$m->id) }}">查看</a>
                    </td>
                    </tr>
                    @endforeach
                    @else

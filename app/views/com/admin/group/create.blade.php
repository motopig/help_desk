    ...
    <div class="col-lg-12">
        ...
        <form class="col-sm-6" role="form" method="post">
            ...
            <div class="form-group clearfix {{{ $errors->has('group_name') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Group Name" name="group_name" id="group_name" value="{{{ Input::old('group_name') }}}" />
            ...
            <div id="select_new_user" class="hidden">
                <div class="form-group clearfix {{{ $errors->has('user_id') ? 'has-error' : '' }}}">
                    ...
                    <div class="col-sm-10">
                        ...
                        <select name="user_id" id="user_id" class="form-control">
                            ...
                            @endforeach
                            @else
                            <option value="0">还未创建过客服，请取消选择已有客服选项！</option>
                            @endif
                        </select>

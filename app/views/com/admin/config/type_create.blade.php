    ...
    <div class="col-lg-12">
        ...
        <form class="col-sm-6" role="form" method="post">
            ...
            <div class="form-group clearfix {{{ $errors->has('work_type_name') ? 'has-error' : '' }}}">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Work Type Name" name="work_type_name" id="work_type_name" value="{{{ Input::old('work_type_name') }}}" />
